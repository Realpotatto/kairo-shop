    ...
    <div className="space-y-6 flex flex-col h-[calc(100vh-4rem)]">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" asChild>
          <Link href="/bots"><ArrowLeft className="h-5 w-5" /></Link>
        </Button>
      ...
      <Tabs defaultValue="overview" className="flex-1 flex flex-col">
        <TabsList className="grid w-full grid-cols-5 lg:w-[600px]">
          ...
          <TabsTrigger value="commands"><Terminal className="mr-2 h-4 w-4"/> Commands</TabsTrigger>
          <TabsTrigger value="plugins"><Blocks className="mr-2 h-4 w-4"/> Plugins</TabsTrigger>
          <TabsTrigger value="stats"><Activity className="mr-2 h-4 w-4"/> Stats</TabsTrigger>
